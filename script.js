...
// Create container and row elements
...
f_div2.innerHTML = `<label for="last-name" class="form-label">Last Name</label>`;
...
// Email input field
const f_divEmail = document.createElement("div");
f_divEmail.setAttribute("class", "form-group mb-3");
f_divEmail.innerHTML = `<label for="email" class="form-label">Email</label>`;
...
f_divEmail.append(email);
form1.append(f_divEmail);
...
// Append form to the column, row, and container
Column1.append(form1);
Row1.append(Column1);
Container1.append(Row1);
document.body.append(Container1);

// Create and append the user table container
...
R_div1.innerHTML = `
<h4 class="bg-light text-center pt-2 pb-2">User Table</h4>
<p id="description" class="text-center">This below User Table holds the user-entered information only</p>`;
